    ...
    const seoFaqs = [
        {
            ...
            a: "Ya, harga yang tercantum dalam pricelist BYD Cibubur adalah harga On The Road (OTR) untuk wilayah Jakarta, Depok, Tangerang, dan Bekasi (Plat B). Harga sudah mencakup BBN-KB (Bea Balik Nama Kendaraan Bermotor) untuk mobil listrik, pembuatan STNK, dan BPKB."
        },
        {
            q: "Apakah harga mengikat saat pemesanan (SPK)?",
            a: "Harga tidak mengikat sampai dengan faktur diterbitkan. Namun, dengan melakukan SPK (Surat Pemesanan Kendaraan) di BYD Cibubur, Anda akan mendapatkan prioritas alokasi unit dan penguncian promo yang berlaku pada bulan pemesanan."
        },
        {
        ...
        <div className="pt-24 pb-20 min-h-screen bg-slate-50 dark:bg-[#0B1215] transition-colors duration-300">
            ...
            <div className="container mx-auto px-4 md:px-8 mb-12 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed text-sm md:text-base">
                    Berikut adalah <strong>pricelist BYD terbaru</strong> (On The Road) untuk wilayah Jakarta, Cibubur, Depok, Tangerang, dan Bekasi. Temukan mobil listrik impian Anda dengan penawaran terbaik bulan ini.
                </p>
            </div>
                    ...
                    <div key={model.id} className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-lg transition-all duration-300">
                        <div className="flex flex-col md:flex-row-reverse">
                            ...
                            <div className="md:w-2/5 relative bg-gray-100 dark:bg-slate-700 p-8 flex items-center justify-center group cursor-pointer">
                                ...
                                <img
                                    src={model.heroImage}
                                    alt={`Harga ${model.name} OTR Jakarta Cibubur`}
            ...
            <div className="bg-slate-50 dark:bg-[#0B1215] py-16">
                <div className="container mx-auto px-4 md:px-8 max-w-4xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div>
                            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Informasi Penjualan BYD Cibubur</h3>
                            <div className="prose prose-sm dark:prose-invert text-gray-600 dark:text-gray-400 leading-relaxed">
                                <p className="mb-4">
                                    <strong>BYD Cibubur</strong> berkomitmen memberikan transparansi harga dan pelayanan terbaik bagi calon pemilik mobil listrik di Indonesia.
                                </p>
                                <p>
